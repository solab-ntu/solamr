...
FakeLocalPlannerROS::~FakeLocalPlannerROS()
{;}
void FakeLocalPlannerROS::initialize(std::string name, tf::TransformListener* tf, costmap_2d::Costmap2DROS* costmap_ros)
...
*/
{
  ...
  computeVelocityCommands(dummy_pose, dummy_velocity, cmd_vel_stamped, dummy_message);
