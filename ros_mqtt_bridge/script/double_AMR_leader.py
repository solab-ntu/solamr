...
def main(args):
    ...
    ros_mqtt_bridge.init_subscriber("/car2/current_state",
                                    "car2_current_state",
                                    "std_msgs/String")
    ros_mqtt_bridge.init_subscriber("/car2/theta",
                                    "car2_theta",
                                    "std_msgs/Float64")
    ros_mqtt_bridge.init_publisher("/car2/cmd_vel",
                                   "p2p_cmd",
                                   "geometry_msgs/Twist")
    ros_mqtt_bridge.init_tf_subscriber(frame_id = "car2/raw/map",
                                       child_id = "car2/raw/odom",
                                       mqtt_topic="mqtt_tf_1")
    ros_mqtt_bridge.init_tf_subscriber(frame_id = "car2/raw/odom",
