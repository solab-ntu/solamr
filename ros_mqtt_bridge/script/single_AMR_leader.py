...
def main(args):
    ...
    ros_mqtt_bridge.init_publisher("/car1/current_state", "car1_current_state", "std_msgs/String")
    ros_mqtt_bridge.init_subscriber("/car2/current_state", "car2_current_state", "std_msgs/String")
